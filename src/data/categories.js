export const categories = [
  {
    id: "faith-in-god",
    group: "Core Value",
    title: "Faith in God (Spirit)",
    intro:
      "A journey of spiritual growth and deepening relationship with the divine.",
    images: [
      {
id: 1,
        src: "/assets/images/faith-in-god/1.jpg",
        alt: "Simple prayer to start the day",
        caption: "Starting Prayer",
        reflection: "This photo shows me saying a simple starting prayer before doing anything else in my day. I have learned that beginning with a short prayer centers my mind on what actually matters instead of getting lost in the noise. The stillness of that first moment has become a sacred space where I reconnect with my faith and gather strength for whatever lies ahead. Over time, this small ritual has changed how I face both problems and opportunities with more grace and trust. It has taught me that faith is not only about belief, but about deliberately choosing to orient my whole life toward something greater than myself. Every day I am reminded that I do not have to carry my burdens alone."
      },
      {
        id: 2,
      ...
      },
      {
        ...
        alt: "Reading the Bible on my PC",
        caption: "Sacred Study",
        reflection:
          "This photo shows me reading the Bible on my PC, since I do not have a printed copy of my own. I have learned that the Word matters more than the form it comes in, and reading it online lets me study anytime, anywhere. I approach these writings not as distant history but as living words that speak into my everyday life. The discipline of regular study has sharpened my thinking while also feeding my spiritual imagination. I have noticed that the same passages offer entirely new insights depending on where I am in my journey. This practice has taught me that faith asks for both an active mind and an open heart.",
      },
      {
        id: 5,
  ...
  },
  {
    id: "love-of-wisdom",
    group: "Core Value",
    title: "Love of Wisdom (Intelligence)",
    intro:
      "A lifelong pursuit of knowledge, understanding, and intellectual growth.",
    images: [
      {
        id: 1,
  ...
  {
    id: "service-to-fellowmen",
    group: "Core Value",
    title: "Service to Fellowmen (Purpose)",
    intro:
      "Finding meaning through contributing to the well-being of others and community.",
    images: [
      {
        id: 1,
  ...
  {
    id: "builder-and-innovator",
    group: "BEST Attribute",
    title: "Builder and Innovator of Knowledge",
    intro:
      "Creating new knowledge and solutions through creativity, research, and innovation.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    group: "BEST Attribute",
    title: "Efficient Professional and Effective Communicator",
    intro:
      "Developing professional excellence and the ability to communicate ideas clearly and persuasively.",
    images: [
      {
        id: 1,
  ...
  {
    id: "social-moral-global",
    group: "BEST Attribute",
    title: "Social, Moral and Global Minded Citizen",
    intro:
      "Engaging with local and global communities while developing ethical awareness and cultural understanding.",
    images: [
      {
        id: 1,
      ...
      },
      {
        ...
        alt: "Clearing unwanted grass and weeds",
        caption: "Caring for the Environment",
        reflection:
          "This photo shows me clearing unwanted grass and weeds around our home, a small act of caring for the environment. I learned that social responsibility means thinking about how my choices affect the people and places around me, even beyond my own doorstep. Removing the grass by hand taught me that small individual actions do add up when many people do them. The experience reminded me that even ordinary tasks, done with care, help keep the place we share clean and healthy. I discovered that living responsibly is not about being perfect but about making steady, caring choices. One small task is a start, and every start matters.",
      },
    ],
  },
  {
    id: "transformed-lifelong-learner",
    group: "BEST Attribute",
    title: "Transformed Lifelong Learner",
    intro:
      "Embracing continuous growth, adaptation, and personal transformation through learning.",
    images: [
      {
        id: 1,
