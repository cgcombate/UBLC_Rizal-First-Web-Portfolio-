export const categories = [
  {
    ...
    intro: "A journey of spiritual growth and deepening relationship with the divine.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    intro: "A lifelong pursuit of knowledge, understanding, and intellectual growth.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    intro: "Finding meaning through contributing to the well-being of others and community.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    intro: "Creating new knowledge and solutions through creativity, research, and innovation.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    intro: "Developing professional excellence and the ability to communicate ideas clearly and persuasively.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    intro: "Engaging with local and global communities while developing ethical awareness and cultural understanding.",
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    intro: "Embracing continuous growth, adaptation, and personal transformation through learning.",
    images: [
      {
        id: 1,
